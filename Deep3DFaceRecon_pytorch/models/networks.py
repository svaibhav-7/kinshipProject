...
def resize_n_crop(image, M, dsize=112):
    # image: (b, c, h, w)
    # M   :  (b, 2, 3)
    return kornia.geometry.warp_affine(image, M, dsize=(dsize, dsize))
...
# Removed define_net_recog as it's not needed for mesh reconstruction
...
# Removed RecogNetWrapper as it's not needed for mesh reconstruction
